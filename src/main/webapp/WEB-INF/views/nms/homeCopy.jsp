        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <h2 class="h5 mb-0 text-gray-800">메인 모니터링</h2>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <%--CountInit Modal --%>
                        <div class="modal fade" id="CountInitModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                             aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">Click "Count Reset" below if you are ready to reset your device.</div>
                        ...
                        <%--Repeat Button--%>
                        <li class="nav-item dropdown no-arrow mx-1">
                            <a href class="nav-link dropdown-toggle" href="#" id="BarButton_Repeat" role="button">
                                <i class="fa fa-spinner fa-sm fa-fw mr-2 text-gray-400">
                                </i>
                            </a>
                        </li>
